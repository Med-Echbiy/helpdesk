    ...
    <section className='text-center text-white' id='hero'>
      <div className='hero_bannersection background--primary' id='hero_banner'>
        <div className='container' data-aos='fade-up'>
          <h1
            className='display-6 fw-bold mt-4 headline--primary'
            id='hero_text'
          >
            How can we help? 👋
          </h1>
          ...
          <div
            className='input-group mt-3 w-100 mx-auto'
            style={{ maxWidth: "500px" }}
          >
            <div
              className='mt-3 p-2 w-50 background--complementary searchbar w-100'
            ...
            >
              ...
              >
                <div className='d-flex w-100'>
                  <svg
                    className='promoted-search__search-icon opacity-25'
                    style={{ width: "30px" }}
                    viewBox='0 0 24 24'
                  >
